...
async def connect(client,message):
	await message.reply_text('Send Me Your api_key from pdisk\nhttps://pdisk.pro/api',reply_to_message_id = message.message_id,reply_markup=ForceReply(True))
